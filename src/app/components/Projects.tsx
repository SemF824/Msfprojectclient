      ...
      <div className="container mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white border border-[#d4af37]/30 shadow-sm mb-4"
          >
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="w-full lg:w-1/2 relative">
                ...
                <div 
                  className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-xl border border-gray-100 bg-white isolate transform-gpu"
              ...
              <div className="w-full lg:w-1/2 space-y-4 md:space-y-6">
                ...
                <Link to={`/vitrine/projet/${project.slug}`} className="group/btn mt-4 w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-[#0a0f1e] text-white font-semibold rounded-xl hover:bg-[#d4af37] hover:text-[#0a0f1e] transition-all shadow-md hover:shadow-lg">
