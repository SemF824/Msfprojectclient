...
export default function DevisRequest() {
  ...
  // Données de propriété (Simulées ou reçues via contexte externe)
  const property = {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase
        ...
        .insert([{
          ...
          down_payment_amount: formData.downPaymentAmount
            ? parseInt(formData.downPaymentAmount, 10) : null,
          visit_date: formData.visitDate || null,
          visit_time: formData.visitTime || null,
          number_of_persons: parseInt(formData.numberOfPersons, 10),
      ...
      toast.success("Demande de devis enregistrée avec succès.");
      setIsSubmitted(true);

      // Redirection directe vers l'espace client protégé
      setTimeout(() => {
        navigate("/client/dashboard");
      }, 3000);
    } catch (error) {
      console.error('Erreur soumission devis:', error);
      toast.error("Échec de la soumission. Veuillez vérifier vos informations réseau.");
    } finally {
      ...
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Prénom <span className="text-red-500">*</span></label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Nom <span className="text-red-500">*</span></label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Email <span className="text-red-500">*</span></label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Téléphone Principal <span className="text-red-500">*</span></label>
                    <input
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Adresse Complète <span className="text-red-500">*</span></label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Ville <span className="text-red-500">*</span></label>
                    <input
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Profession <span className="text-red-500">*</span></label>
                    <input
                      type="text" required value={formData.profession}
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm text-gray-700 mb-2 font-medium">Revenus Mensuels (Optionnel)</label>
                    <select
                      value={formData.monthlyIncome}
                      onChange={(e) => handleInputChange("monthlyIncome", e.target.value)}
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-[#0a0f1e] focus:border-[#d4af37] focus:outline-none transition-colors bg-white"
                    >
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium"> Type de Projet <span className="text-red-500">*</span></label>
                    <select
                      required value={formData.requestType}
                  ...
                  <div>
                    <label className="block text-sm text-gray-700 mb-2 font-medium">Financement Nécessaire ?</label>
                    <select
                  ...
                  {formData.financingNeeded === "oui" && (
                    <div className="md:col-span-2">
                      <label className="block text-sm text-gray-700 mb-2 font-medium">Apport Personnel Estimé (FCFA)</label>
                      <input
                        type="text" value={formData.downPaymentAmount}
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      type="date" value={formData.visitDate}
              ...
              >
                <div className="space-y-4">
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                      type="checkbox" required checked={formData.acceptTerms}
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                      type="checkbox" checked={formData.acceptContact}
          ...
          <div className="lg:col-span-1 space-y-6">
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-white rounded-2xl border border-gray-200 shadow-lg p-6 sticky top-24">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="bg-gradient-to-br from-[#d4af37]/10 to-transparent rounded-2xl border border-[#d4af37]/30 p-6">
              <h3 className="text-lg text-[#0a0f1e] font-semibold mb-4">Besoin d'Aide ?</h3>
              <div className="space-y-3">
                <a href="tel:+242064588618" className="flex items-center gap-3 text-gray-700 hover:text-[#d4af37] transition-colors">
                ...
                <a href="mailto:promotions@msfcongo.com" className="flex items-center gap-3 text-gray-700 hover:text-[#d4af37] transition-colors">
